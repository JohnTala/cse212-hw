...
public class TakingTurnsQueueTests
{
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: People with 0 turns are not added back to the queue, even though 0 means infinite turns.
    ...
    // Defect(s) Found: People with negative turns are not added back to the queue, even though 0 or less means infinite turns.
